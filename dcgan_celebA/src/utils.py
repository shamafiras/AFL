...
def get_data_loader(opt, train=True, main=True):
    ...
    if opt.data_set == 'celebA':
        if main is True:
            ...
            data_set = CelebADataSet(root=opt.data_set_path, transform=transform, attr=opt.discriminator_bank_attr, is_attr=opt.discriminator_bank_attr_is)
